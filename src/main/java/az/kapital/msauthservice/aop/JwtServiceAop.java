...
@Component
@Slf4j
public class JwtServiceAop {

    @Pointcut(value = "execution(* az.kapital.msauthservice.service.JwtService.*(..))")
    public void jwtServiceMethods() {
    }

    @Around(value = "jwtServiceMethods()")
    ...
    @AfterReturning(value = "jwtServiceMethods()", returning = "result")
